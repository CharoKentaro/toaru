...
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
# ★★★ ここで、どの画面を表示するかを管理する変数を初期化します ★★★
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
if 'view_mode' not in st.session_state:
    st.session_state.view_mode = "main" # デフォルトはメインツール
...
with st.sidebar:
    ...
    # ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
    # ★★★ ここに、ヘルプツールを呼び出すための新しいセクションを追加します ★★★
    # ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
    with st.expander("📖 設定・ヘルプガイド"):
        st.caption("APIキーの取得方法が分からない場合は、こちらをご利用ください。")
        # Gemini APIキーガイドを呼び出すボタン
        if st.button("💎 Gemini APIキー設定ガイド", use_container_width=True):
            st.session_state.view_mode = "gemini_helper"
            st.rerun() # 画面を再読み込みして表示を切り替える
            
        # Maps APIキーガイドを呼び出すボタン
        if st.button("🔑 Maps APIキー簡単設定", use_container_width=True):
            st.session_state.view_mode = "maps_helper"
            st.rerun() # 画面を再読み込みして表示を切り替える
    ...
    st.radio(
        ...
        on_change=lambda: st.session_state.update(view_mode="main") # ツールを選んだらメイン表示に戻す
    )
    st.divider()
...
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
# ★★★ ここで、まずヘルプ画面の表示を優先的にチェックします ★★★
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
if st.session_state.view_mode == "gemini_helper":
    gemini_api_key_helper_tool.show_tool()

elif st.session_state.view_mode == "maps_helper":
    api_key_helper_tool.show_tool()

# ★★★ ヘルプ画面でない場合は、これまで通りのツール選択ロジックを実行します ★★★
else:
    selected_tool = st.session_state.get("tool_selection_sidebar")

    if selected_tool == "💰 お小遣い管理":
